...
TEST(ResourceLimitErrorTest, ToStringMemoryLimitExceeded) {
    EXPECT_STREQ(to_string(ResourceLimitError::MemoryLimitExceeded), "MemoryLimitExceeded");
}
...
TEST(ResourceLimitErrorTest, ToStringStackDepthExceeded) {
    EXPECT_STREQ(to_string(ResourceLimitError::StackDepthExceeded), "StackDepthExceeded");
}

TEST(ResourceLimitErrorTest, ToStringAllocationSizeExceeded) {
    EXPECT_STREQ(to_string(ResourceLimitError::AllocationSizeExceeded), "AllocationSizeExceeded");
}
