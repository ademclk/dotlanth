...
TEST(AuditSeverityTest, ToStringAllValues) {
    EXPECT_EQ(to_string(AuditSeverity::Debug), "Debug");
    EXPECT_EQ(to_string(AuditSeverity::Info), "Info");
    EXPECT_EQ(to_string(AuditSeverity::Warning), "Warning");
    EXPECT_EQ(to_string(AuditSeverity::Error), "Error");
    EXPECT_EQ(to_string(AuditSeverity::Critical), "Critical");
}
...
TEST(AuditEventTypeTest, ToStringAllValues) {
    ...
    EXPECT_EQ(to_string(AuditEventType::DotStarted), "DotStarted");
    EXPECT_EQ(to_string(AuditEventType::DotCompleted), "DotCompleted");
    EXPECT_EQ(to_string(AuditEventType::DotFailed), "DotFailed");
    EXPECT_EQ(to_string(AuditEventType::CapabilityCreated), "CapabilityCreated");
    EXPECT_EQ(to_string(AuditEventType::CapabilityRevoked), "CapabilityRevoked");
    EXPECT_EQ(to_string(AuditEventType::MemoryLimitExceeded), "MemoryLimitExceeded");
    EXPECT_EQ(to_string(AuditEventType::SecurityViolation), "SecurityViolation");
}
