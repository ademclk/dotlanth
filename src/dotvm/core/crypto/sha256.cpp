...
Sha256::Sha256() noexcept : state_(INITIAL_HASH), buffer_{}, buffer_len_(0), total_len_(0) {}
...
Sha256::process_block_sha_ni(std::span<const std::uint8_t, 64> block) noexcept {
    ...
    __m128i MSG0 = _mm_shuffle_epi8(
        _mm_loadu_si128(reinterpret_cast<const __m128i*>(block.data() + 0)), SHUF_MASK);
    __m128i MSG1 = _mm_shuffle_epi8(
        _mm_loadu_si128(reinterpret_cast<const __m128i*>(block.data() + 16)), SHUF_MASK);
    __m128i MSG2 = _mm_shuffle_epi8(
        _mm_loadu_si128(reinterpret_cast<const __m128i*>(block.data() + 32)), SHUF_MASK);
    __m128i MSG3 = _mm_shuffle_epi8(
        _mm_loadu_si128(reinterpret_cast<const __m128i*>(block.data() + 48)), SHUF_MASK);

    __m128i MSG;

    // Rounds 0-3
    MSG = _mm_add_epi32(MSG0, _mm_set_epi64x(static_cast<std::int64_t>(0xE9B5DBA5B5C0FBCFull),
    ...
    // Rounds 4-7
    MSG = _mm_add_epi32(MSG1, _mm_set_epi64x(static_cast<std::int64_t>(0xAB1C5ED5923F82A4ull),
    ...
    // Rounds 8-11
    MSG = _mm_add_epi32(MSG2, _mm_set_epi64x(static_cast<std::int64_t>(0x550C7DC3243185BEull),
    ...
    // Rounds 16-19
    MSG = _mm_add_epi32(MSG0, _mm_set_epi64x(static_cast<std::int64_t>(0x240CA1CC0FC19DC6ull),
    ...
    // Rounds 20-23
    MSG = _mm_add_epi32(MSG1, _mm_set_epi64x(static_cast<std::int64_t>(0x76F988DA5CB0A9DCull),
    ...
    // Rounds 24-27
    MSG = _mm_add_epi32(MSG2, _mm_set_epi64x(static_cast<std::int64_t>(0xBF597FC7B00327C8ull),
    ...
    // Rounds 32-35
    MSG = _mm_add_epi32(MSG0, _mm_set_epi64x(static_cast<std::int64_t>(0x53380D134D2C6DFCull),
    ...
    // Rounds 36-39
    MSG = _mm_add_epi32(MSG1, _mm_set_epi64x(static_cast<std::int64_t>(0x92722C8581C2C92Eull),
    ...
    // Rounds 40-43
    MSG = _mm_add_epi32(MSG2, _mm_set_epi64x(static_cast<std::int64_t>(0xC76C51A3C24B8B70ull),
    ...
    // Rounds 44-47
    MSG = _mm_add_epi32(MSG3, _mm_set_epi64x(static_cast<std::int64_t>(0x106AA070F40E3585ull),
    ...
    // Rounds 48-51
    MSG = _mm_add_epi32(MSG0, _mm_set_epi64x(static_cast<std::int64_t>(0x34B0BCB52748774Cull),
    ...
    // Rounds 52-55
    MSG = _mm_add_epi32(MSG1, _mm_set_epi64x(static_cast<std::int64_t>(0x682E6FF35B9CCA4Full),
    ...
    // Rounds 56-59
    MSG = _mm_add_epi32(MSG2, _mm_set_epi64x(static_cast<std::int64_t>(0x8CC7020884C87814ull),
    ...
    MSG = _mm_add_epi32(MSG3, _mm_set_epi64x(static_cast<std::int64_t>(0xC67178F2BEF9A3F7ull),
                                             static_cast<std::int64_t>(0xA4506CEB90BEFFAull)));
    STATE1 = _mm_sha256rnds2_epu32(STATE1, STATE0, MSG);
    MSG = _mm_shuffle_epi32(MSG, 0x0E);
    STATE0 = _mm_sha256rnds2_epu32(STATE0, STATE1, MSG);
