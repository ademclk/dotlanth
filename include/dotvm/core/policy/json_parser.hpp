...
public:
    ...
    [[nodiscard]] bool is_array() const noexcept { return std::holds_alternative<JsonArray>(data_); }
    [[nodiscard]] bool is_object() const noexcept { return std::holds_alternative<JsonObject>(data_); }
    ...
    [[nodiscard]] const std::string& as_string() const noexcept { return std::get<std::string>(data_); }
    ...
    [[nodiscard]] const JsonObject& as_object() const noexcept { return std::get<JsonObject>(data_); }
