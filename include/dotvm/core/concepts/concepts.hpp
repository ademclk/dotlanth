...
static_assert(AluInterface<ALU>,
              "ALU must satisfy AluInterface concept");
static_assert(BasicAluArithmetic<ALU>,
              "ALU must satisfy BasicAluArithmetic concept");
static_assert(AluBitwiseOps<ALU>,
              "ALU must satisfy AluBitwiseOps concept");
static_assert(AluShiftOps<ALU>,
              "ALU must satisfy AluShiftOps concept");
static_assert(AluSignedComparison<ALU>,
              "ALU must satisfy AluSignedComparison concept");
static_assert(AluUnsignedComparison<ALU>,
              "ALU must satisfy AluUnsignedComparison concept");
...
static_assert(BasicMemoryOps<MemoryManager>,
              "MemoryManager must satisfy BasicMemoryOps concept");
static_assert(TypedMemoryOps<MemoryManager>,
              "MemoryManager must satisfy TypedMemoryOps concept");
static_assert(BulkMemoryOps<MemoryManager>,
              "MemoryManager must satisfy BulkMemoryOps concept");
static_assert(MemoryStats<MemoryManager>,
              "MemoryManager must satisfy MemoryStats concept");
