...
[[nodiscard]] constexpr bool is_simd_architecture(Architecture arch) noexcept {
    return arch == Architecture::Arch128 ||
...
[[nodiscard]] constexpr std::size_t arch_bit_width(Architecture arch) noexcept {
    switch (arch) {
        case Architecture::Arch32:  return 32;
        case Architecture::Arch64:  return 64;
        case Architecture::Arch128: return 128;
        case Architecture::Arch256: return 256;
        case Architecture::Arch512: return 512;
    }
